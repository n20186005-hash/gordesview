        ...
        <div className="space-y-6">
          <div className="card">
            <div className="flex items-center justify-between mb-2">
              ...
              <span className="text-xs px-2 py-1 rounded-full font-medium" style={{ background: 'var(--tag-bg-section)', color: 'var(--tag-text-section)' }}>ON</span>
            </div>
          ...
          <div className="card">
            <div className="flex items-center justify-between mb-2">
              ...
              <span className="text-xs px-2 py-1 rounded-full font-medium" style={{ background: 'var(--border-color)', color: 'var(--text-muted)' }}>OFF</span>
            </div>
